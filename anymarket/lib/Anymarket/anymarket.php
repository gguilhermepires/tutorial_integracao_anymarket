...
class AnyMarket {
     ...
     */
    protected static $API_ROOT_URL = "http://sandbox-api.anymarket.com.br/v2/";
     ...
     * @return mixed
     */
    public function getUrlBae($path, $params = null, $assoc = false) {
    ...
    public function post($path, $body = null, $params = array()) {
        ...
        $opts = array(
            CURLOPT_HTTPHEADER => array('Content-Type: application/json','gumgaToken:L32065740G1590447335016R-502823916'),
            CURLOPT_POST => true, 
    ...
    public function put($path, $body = null, $params = array()) {
        $body = json_encode($body);
        $opts = array(
            CURLOPT_HTTPHEADER => array('Content-Type: application/json','gumgaToken:'.   $this->token),
